...
class Test_Search_Emp:
    ...
    path = "C:\\Users\\admin\\PycharmProjects\\OrangeHrmProject\\TestData\\empsearch_ddt.xlsx"
    ...
    def test_searchEmp_005(self, setup):
        ...
        for r in range(2, self.rows+1):
            self.es.Enter_EmpName(XLUtils.readData(self.path, 'Sheet1',r, 2))
            ...
            #self.driver.save_screenshot(
             #   "C:\\Users\\admin\\PycharmProjects\\OrangeHrmProject\\Screenshots\\test_searchemp_003-pass.png")
